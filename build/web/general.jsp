...
<html>
  ...
  <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    <body>
        ...
        <a href="admin.jsp" class="w3-bar-item w3-button">Current Archive Table</a>
     ...
     <div style="margin-left:25%;display:block" id="iitb-arch-img">     
        <img src="./img/general.jpeg" align="centre"></img>
    </div>    
    </body>
     <%
        }  
